...
c.NotebookApp.tornado_settings = {
    'headers': {
        'Content-Security-Policy': "default-src * 'unsafe-inline'; frame-ancestors *; font-src 'self' about:; img-src 'self' data:;"
    }
}
...
#  Choices: any of ['sha3_512', 'sha256', 'sha384', 'md5', 'sha3_256', 'sha3_224', 'sha224', 'sha1', 'blake2s', 'sha512', 'sha3_384', 'blake2b']
#  Default: 'sha256'
